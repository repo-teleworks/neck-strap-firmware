...
#ifdef FOUR_CHANNEL_IS_USED
	extern SEGMENT_VARIABLE (Parameters[4][11], U8, SEG_CODE);
#endif
#ifdef MORE_CHANNEL_IS_USED
	extern SEGMENT_VARIABLE (Parameters[4][11], U8, SEG_CODE);
#endif

extern SEGMENT_VARIABLE (EZMacProByteTime[4], U16, SEG_CODE);
extern SEGMENT_VARIABLE (FrequencyTable[50],U8, SEG_CODE);
